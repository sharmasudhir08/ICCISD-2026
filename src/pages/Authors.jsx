...
const Authors = () => {
  return (
    <div className='bg-slate-50 font-sans'>
      ...
      <PageBanner title="For Authors" subtitle="Guidelines, dates, and submission details." />
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { label: "Notification of Acceptance", date: "March 30, 2026", color: "text-amber-600" },
                  ...
                  <ol className="list-decimal pl-5 space-y-3 text-slate-600">
                    ...
                    <li>Enter the following:
                      <ul className="list-disc pl-5 mt-1 space-y-1">
                          <li>The Conference ID: <strong>69924X</strong></li>
