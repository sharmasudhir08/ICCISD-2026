...
const PaperSubmission = () => {
  return (
    <div className='bg-slate-50 font-sans'>
      ...
      <PageBanner title="Paper Submission" subtitle="Guidelines and Policy" />
        ...
        <section className="space-y-8">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-3 text-slate-600">
              ...
              <li>Authors can use IEEE PDF eXpress to generate compliant PDF Files for final submission.</li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            ...
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200 flex flex-col items-center text-center space-y-4 hover:shadow-md transition-shadow">
              <img src={ieeelogo} alt="Sharda University" className="h-12 object-contain" />
              <div>
